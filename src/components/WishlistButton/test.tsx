...
describe('<WishlistButton/>', () => {
  it('it should render a button to add to wishlist', () => {
  ...
  it('it should render a button to remove to wishlist', () => {
    const wishlistProviderProps = {
      ...WishlistContextDefaultValues,
      isInWishlist: () => true
    }
  ...
  it('it should render a button to add with text', () => {
    const wishlistProviderProps = {
      ...WishlistContextDefaultValues,
      isInWishlist: () => false
    }
  ...
  it('it should render a button to remove with text', () => {
    const wishlistProviderProps = {
      ...WishlistContextDefaultValues,
      isInWishlist: () => true
    }
