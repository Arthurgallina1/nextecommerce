...
describe('useWishlist', () => {
  ...
  it('should check if the game in the wishlist', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
      <MockedProvider mocks={[wishlistMock]}>
        <WishlistProvider>{children}</WishlistProvider>
      </MockedProvider>
  ...
  it('should add item creating a new wishlist', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
  ...
  it('should add item from wishlist updating the current list', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
